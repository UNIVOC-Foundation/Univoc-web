    ...
    <div className="bg-gradient-to-r from-black to-blue-900 text-white p-6 md:p-12">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <button class="bg-sky-500 p-2 rounded hover:bg-sky-700 ...">
                  Save changes22
         </button>
         <button class="bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 ...">
 
</button>
          <button className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded shadow-lg">
           <a href="#">Apply Now </a>
          </button>
        </div>
        {/* Right Section */}
        <div className="flex-1 relative mt-8 md:mt-0 ">
          <div className="flex justify-center md:justify-end space-x-4 group-hover:">
            {/* Students Images */}
            <img
              ...
              alt="Student 1"
              className="w-full h-full md:w-32 md:h-32 rounded-full border-4 border-blue-500 focus:ring focus:ring-violet-300 "
            />
            <img
              ...
              alt="Student 2"
              className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-blue-500  hover:bg-blue-100"
            />
            <img
          ...
          {/* Outline Placeholder */}
          <div className="absolute top-16 left-8 md:top-24 md:left-16 text-white text-lg italic">
